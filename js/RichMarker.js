...
(function () {
    ...
    /**
     * 获取Marker的infowindow content
     * @return infowindow content 显 
     * 
     * @example <b>参考示例：</b>
     * myRichMarkerObject.getInfoWindow();
     */
    RichMarker.prototype.getInfoWindow = function () {
        return this._infoWindow;
    }

    /**
     * 设置Marker的infowindow content
     * @param infowindow content 需要设置HTML
     * @return 无返回值
     * 
     * @example <b>参考示例：</b>
     * myRichMarkerObject.setInfoWindow(new BMap.Point(116.30816, 40.056863));
     */
    RichMarker.prototype.setInfoWindow  = function (infocontent) {
        if (!infocontent) {
            return;
        }
        this._infoWindow = infocontent; 
    }
  /**
     * 设置Marker的infowindow OPEN
     *  
     * @return 无返回值 
     * @example <b>参考示例：</b>
     * myRichMarkerObject.openInfoWindow();
     */
    RichMarker.prototype.openInfoWindow  = function () {
        if (!this._infoWindow&&!this._position) {
            return;
        }
        this._map.openInfoWindow(this._infoWindow, this._position);
    }
